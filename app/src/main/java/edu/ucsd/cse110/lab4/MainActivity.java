...
public class MainActivity extends AppCompatActivity {
    ...
    public void onShowCounterClicked(View view){
        ...
        if (!maybeMaxCount.isPresent()) {
            ...
            Utilities.showAlter(this, "This isn't a numbewr!");
            return;
        }
        // Get the integer
        ...
        if (maxCount <= 0) {
            Utilities.showAlter(this, "please enter a positive number!");
            return;
        }
//        Utilities.showAlter(this, String.format(("I got the number %d"),maxCount));
